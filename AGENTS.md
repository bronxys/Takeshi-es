...
This Bronxys edition documents and promotes only Bronxys. It intentionally does not
include the automated project test suite, CI workflow, or assets from other hosts.
